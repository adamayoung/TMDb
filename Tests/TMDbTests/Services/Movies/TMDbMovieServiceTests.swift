...
class TMDbMovieServiceTests: XCTestCase {
    ...
    func testFetchReviewsReturnsReviews() throws {
        ...
        let result = try await(publisher: service.fetchReviews(forMovie: movieID), storeIn: &cancellables)
    ...
    func testFetchRecommendationsReturnsMovies() throws {
        ...
        let result = try await(publisher: service.fetchRecommendations(forMovie: movieID), storeIn: &cancellables)
    ...
    func testFetchSimilarReturnsMovies() throws {
        ...
        let result = try await(publisher: service.fetchSimilar(toMovie: movieID), storeIn: &cancellables)
