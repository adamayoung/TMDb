...
class TVShowEpisodeDTOTests: XCTestCase {

    func testDecodeReturnsTVShowEpisode() throws {
        let data = json.data(using: .utf8)!
        let result = try JSONDecoder.theMovieDatabase.decode(TVShowEpisodeDTO.self, from: data)
    ...
    private let tvShowEpisode = TVShowEpisodeDTO(
        id: 63056,
        name: "Winter Is Coming",
        episodeNumber: 1,
        seasonNumber: 1,
