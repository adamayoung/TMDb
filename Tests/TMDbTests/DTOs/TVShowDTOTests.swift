...
class TVShowDTOTests: XCTestCase {

    func testFirstAirDateWhenNilReturnsNil() {
        let someTVShow = TVShowDTO(id: 1, name: "Some tv show name 1", firstAirDate: nil)

        XCTAssertNil(someTVShow.firstAirDate)
    }

    func testHomepageURLWhenNilReturnsNil() {
        let someTVShow = TVShowDTO(id: 2, name: "Some tv show name 2", homepageURL: nil)
    ...
    func testHomepageURLWhenHasURLReturnsURL() {
        ...
        let someTVShow = TVShowDTO(id: 3, name: "Some tv show name 3", homepageURL: expectedResult)
    ...
    func testDecodeReturnsTVShow() throws {
        ...
        let result = try JSONDecoder.theMovieDatabase.decode(TVShowDTO.self, from: data)
