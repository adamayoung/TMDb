...
class PersonMovieCreditsDTOTests: XCTestCase {

    func testDecodeReturnsPersonMovieCredits() throws {
        let data = json.data(using: .utf8)!
        let result = try JSONDecoder.theMovieDatabase.decode(PersonMovieCreditsDTO.self, from: data)
    ...
    private let personMovieCredits = PersonMovieCreditsDTO(
        id: 287,
        cast: [
            MovieDTO(
                id: 109091,
