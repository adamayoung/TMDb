...
class PersonCombinedCreditsDTOTests: XCTestCase {

    func testDecodeReturnsPersonCombinedCredits() throws {
        let data = json.data(using: .utf8)!
        let result = try JSONDecoder.theMovieDatabase.decode(PersonCombinedCreditsDTO.self, from: data)
    ...
    private let personCombinedCredits = PersonCombinedCreditsDTO(
        id: 287,
        cast: [
            .tvShow(TVShowDTO(
                id: 54,
