...
class PersonTVShowCreditsDTOTests: XCTestCase {

    func testDecodeReturnsPersonTVShowCredits() throws {
        let data = json.data(using: .utf8)!
        let result = try JSONDecoder.theMovieDatabase.decode(PersonTVShowCreditsDTO.self, from: data)
    ...
    private let personTVShowCredits = PersonTVShowCreditsDTO(
        id: 287,
        cast: [
            TVShowDTO(
                id: 54,
