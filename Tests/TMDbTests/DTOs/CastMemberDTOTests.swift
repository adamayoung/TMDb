...
class CastMemberDTOTests: XCTestCase {

    func testDecodeReturnsCastMember() throws {
        let data = json.data(using: .utf8)!
        let result = try JSONDecoder.theMovieDatabase.decode(CastMemberDTO.self, from: data)
    ...
    private let castMember = CastMemberDTO(
        id: 819,
        castID: 4,
