...
class APIConfigurationDTOTests: XCTestCase {

    func testDecodeReturnsAPIConfiguration() throws {
        let data = json.data(using: .utf8)!
        let result = try JSONDecoder.theMovieDatabase.decode(APIConfigurationDTO.self, from: data)
    ...
    private let apiConfiguration = APIConfigurationDTO(
