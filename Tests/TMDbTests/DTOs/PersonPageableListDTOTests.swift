...
class PersonPageableListDTOTests: XCTestCase {

    func testDecodeReturnsPersonPageableList() throws {
        let data = json.data(using: .utf8)!
        let result = try JSONDecoder.theMovieDatabase.decode(PersonPageableListDTO.self, from: data)
    ...
    private let list = PersonPageableListDTO(
        page: 1,
        results: [
            PersonDTO(
                id: 287,
