...
class ShowDTOTests: XCTestCase {
    ...
    func testDecodeReturnsMovie() throws {
        ...
        let result = try JSONDecoder.theMovieDatabase.decode(ShowDTO.self, from: data)
    ...
    private let movieShow: ShowDTO = .movie(MovieDTO(
        id: 109091,
        title: "The Counselor",
    ...
    private let tvShowShow: ShowDTO = .tvShow(TVShowDTO(
        id: 54,
        name: "Growing Pains",
