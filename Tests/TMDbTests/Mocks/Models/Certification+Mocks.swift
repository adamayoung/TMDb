...
extension Certification {
    ...
    static var gbPG: Self {
        .mock(
            code: "PG",
            meaning: "All ages admitted, but certain scenes may be unsuitable for young children. May contain mild "
    ...
    static var gb12A: Self {
        .mock(
            code: "12A",
            meaning: "Films under this category are considered to be unsuitable for very young people. Those aged "
    ...
    static var usG: Self {
        .mock(
            code: "G",
            meaning: "All ages admitted. There is no content that would be objectionable to most parents. This is one "
    ...
    static var usPG13: Self {
        .mock(
            code: "PG-13",
            meaning: "Some material may be inappropriate for children under 13. Films given this rating may contain "
