//
//  TVSeriesChangesRequestTests.swift
//  TMDb
//
...
struct TVSeriesChangesRequestTests {

    @Test("path is correct")
    func path() {
        let request = TVSeriesChangesRequest(id: 1)

        #expect(request.path == "/tv/1/changes")
    }
    ...
    func queryItemsContainsStartDate() {
        ...
        let request = TVSeriesChangesRequest(id: 1, startDate: date)
    ...
    func queryItemsContainsEndDate() {
        ...
        let request = TVSeriesChangesRequest(id: 1, endDate: date)
    ...
    func queryItemsContainsPage() {
        let request = TVSeriesChangesRequest(id: 1, page: 2)
    ...
    func queryItemsContainsAllParameters() {
        ...
        let request = TVSeriesChangesRequest(id: 1, startDate: startDate, endDate: endDate, page: 2)
