...
struct AddMediaRequestTests {

    @Test("path is correct")
    func path() {
        let request = AddMediaRequest(mediaID: 550, listID: 1234, sessionID: "abc123")

        #expect(request.path == "/list/1234/add_item")
    }
    ...
    func bodyEncodingUsesCorrectCodingKeys() throws {
        let bodyValue = AddMediaRequest.Body(mediaID: 550)
