...
final class TVShowEpisodeServiceTests: XCTestCase {
    ...
    func testDetails() async throws {
        ...
        let episode = try await tvShowEpisodeService.details(forEpisode: episodeNumber, inSeason: seasonNumber, inTVShow: tvShowID)
    ...
    func testImages() async throws {
        ...
        let imageCollection = try await tvShowEpisodeService.images(forEpisode: episodeNumber, inSeason: seasonNumber, inTVShow: tvShowID)
    ...
    func testVideos() async throws {
        ...
        let videoCollection = try await tvShowEpisodeService.videos(forEpisode: episodeNumber, inSeason: seasonNumber, inTVShow: tvShowID)
