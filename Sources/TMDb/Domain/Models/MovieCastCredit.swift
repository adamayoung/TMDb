...
///
/// A model representing a movie cast credit.
///
/// Combines movie metadata with cast-specific credit information such as
/// character name and billing order.
///
public struct MovieCastCredit: Identifiable, Codable, Equatable, Hashable, Sendable {
    ...
    ///
    /// Character name played by the person in this movie.
    ///
    ...
    ///
    /// Order number in the cast list (billing order).
    ///
    public let order: Int

    ///
    /// Creates a movie cast credit object.
    ///
    /// - Parameters:
    ///    - id: Movie identifier.
    ///    - title: Movie title.
