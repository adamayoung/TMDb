...
///
/// A model representing a TV series cast credit.
///
/// Combines TV series metadata with cast-specific credit information such as
/// character name and episode count.
///
public struct TVSeriesCastCredit: Identifiable, Codable, Equatable, Hashable, Sendable {
    ...
    ///
    /// Character name played by the person in this TV series.
    ///
    ...
    ///
    /// Creates a TV series cast credit object.
    ///
    /// - Parameters:
    ...
    ///    - episodeCount: Number of episodes the person appeared in.
    ///    - character: Character name played by the person.
