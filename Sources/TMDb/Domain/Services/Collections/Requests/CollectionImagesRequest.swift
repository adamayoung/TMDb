...
final class CollectionImagesRequest: DecodableAPIRequest<CollectionImageCollection> {

    init(id: Collection.ID, languages: [String]? = nil) {
        let path = "/collection/\(id)/images"
