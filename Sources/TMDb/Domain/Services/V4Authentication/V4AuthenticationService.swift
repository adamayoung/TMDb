...
public protocol V4AuthenticationService: Sendable {
    ...
    /// they are issued.
    ///
    /// [TMDb API - Auth: Create Request
    /// Token](https://developer.themoviedb.org/v4/reference/auth-create-request-token)
    ///
    ...
    ///
    /// [TMDb API - Auth: Create Access
    /// Token](https://developer.themoviedb.org/v4/reference/auth-create-access-token)
    ///
    ...
    ///
    /// [TMDb API - Auth:
    /// Logout](https://developer.themoviedb.org/v4/reference/auth-logout)
    ///
