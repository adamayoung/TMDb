...
final class TVSeriesChangesRequest: DecodableAPIRequest<ChangeCollection> {

    init(id: TVSeries.ID, startDate: Date? = nil, endDate: Date? = nil, page: Int? = nil) {
        let path = "/tv/\(id)/changes"
