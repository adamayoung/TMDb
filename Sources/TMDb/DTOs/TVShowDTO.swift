...
public struct TVShowDTO: Identifiable, Decodable, Equatable, PosterURLProviding, BackdropURLProviding {
    ...
    public let seasons: [TVShowSeasonDTO]?
    ...
    public init(id: Int, name: String, originalName: String? = nil, originalLanguage: String? = nil,
                ...
                numberOfEpisodes: Int? = nil, seasons: [TVShowSeasonDTO]? = nil, genres: [GenreDTO]? = nil,
                ...
                languages: [String]? = nil, lastAirDate: Date? = nil, networks: [NetworkDTO]? = nil,
                productionCompanies: [ProductionCompanyDTO]? = nil, status: String? = nil, type: String? = nil,
