...
public final class TMDbSearchService: SearchService {
    ...
    public func searchAll(query: String, page: Int?) -> AnyPublisher<MultiTypePageableListResult, TMDbError> {
    ...
    public func searchPeople(query: String, page: Int?) -> AnyPublisher<PersonPageableListResult, TMDbError> {
